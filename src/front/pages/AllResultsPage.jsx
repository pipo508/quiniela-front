...
import { mockResults } from '../data/mockResults'; // <-- Importamos "mockResults" con llaves
...
const AllResultsPage = () => {
  ...
  const resultadosFiltrados = useMemo(() => {
    ...
    // Asegurarse de que no intentamos acceder a una clave undefined
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.filterContainer}>
        ...
        {juegos.map(juego => (
          <button key={juego.id} onClick={() => setFiltro(juego.id)} className={filtro === juego.id ? styles.active : ''}>
            {juego.nombre}
          </button>
        ))}
      </div>
